...
const Page04 = () => {
  ...
  return (
    <div>
      <DetailPageTitle title="국내출원품의 상세" />
      <div className="space-y-4">
        <FlexBox className="gap-5">
          <RHF.Input control={form.control} name="val1" label="작성자" disabled />
          <RHF.Input control={form.control} name="val1" label="작성일" disabled />
        </FlexBox>

        <FlexBox className="gap-5">
          <RHF.Input control={form.control} name="val1" label="PLM No." disabled />
          <RHF.Input control={form.control} name="val1" label="권리구분" disabled />
        </FlexBox>
        ...
        <FlexBox className="gap-5">
          <RHF.Input control={form.control} name="val1" label="비용집행근거" disabled />
          <RHF.Input control={form.control} name="val1" label="코스트센터" disabled />
        </FlexBox>

        <div className="border-border-100 border-b py-4">
          <h2 className="font-semibold">발명자 기본 입력사항</h2>
        </div>
        ...
        {/* 발명자 */}
        <Table12 form={form} hiddenCheck={true} onlyRead={true} />
