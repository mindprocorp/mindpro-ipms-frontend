  ...
  return (
    <div className="text-xs">
      <Button
        ...
        className="data-[selected=true]:bg-p-color-1/10 data-[selected=true]:[&>span]:text-p-color-1 w-full justify-start gap-1 [&_span]:pl-[calc(var(--space)*16px)] [&+div]:hidden data-[active=true]:[&+div]:block"
        data-active={active}
        data-selected={group.code === activeCode}
        onClick={() => handleActive(group.code)}
      >
