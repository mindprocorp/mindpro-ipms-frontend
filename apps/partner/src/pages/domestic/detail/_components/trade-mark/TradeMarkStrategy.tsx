    ...
    <FormUnitBox vertical title="출원 전략설정">
      ...
      <UnitInnerBox className="bg-info-bg">
        ...
        <RHF.FormField gap={2}>
          <RHF.Input
            control={control}
            name="appStrategy.madridAppInfo.madridAppNo"
            label="국제등록번호"
            krAppNoOnly
            placeholder="번호입력"
          />
          <RHF.FormDatePicker
            control={control}
            name="appStrategy.madridAppInfo.madridAppDate"
            label="국제등록일"
          />
        </RHF.FormField>
      </UnitInnerBox>
...
export default TradeMarkStrategy;
