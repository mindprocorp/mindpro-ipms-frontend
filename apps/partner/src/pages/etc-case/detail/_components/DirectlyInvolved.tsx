...
const DirectlyInvolved = () => {
  ...
  const onCstSelect = (item: CustomerSelected) => {
    setValue(cstModal.inputKey as Path<EtcCaseFormInput>, item.customerSeq, { shouldValidate: true, shouldDirty: true });
    setValue(cstModal.inputName as Path<EtcCaseFormInput>, item.customerName, { shouldValidate: true, shouldDirty: true });
  };
