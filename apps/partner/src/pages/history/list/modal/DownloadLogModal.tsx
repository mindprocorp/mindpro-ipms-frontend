...
import {
  type DownloadLogColType,
  downloadLogColumnsData,
} from "./columns/downloadLogColumnsData.tsx";
import { useState } from "react";

const DownloadLogModal = ({ title, open, onOpenChange }: ModalProps) => {
  const [listData, setListData] = useState<DownloadLogColType[]>([]);
  ...
  return (
    ...
    >
      ...
      <DataTable
        data={listData}
        columns={downloadLogColumnsData}
        height={400}
      />
    </FormDialog>
  );
