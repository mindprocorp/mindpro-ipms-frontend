...
const Representative = () => {
  ...
  const onSuccess = (rtnData: SuccessData) => {
    ...
    setValue(rtnData.input.inputKey as Path<ObjectionTrialFormInput>, user.id, { shouldValidate: true });
    setValue(rtnData.input.inputName as Path<ObjectionTrialFormInput>, user.name, { shouldValidate: true });
    // 부서는 '관리담당자(adminMgr)' 선택 시에만 자동 세팅 (사건담당자/담당변리사는 부서 영향 없음)
