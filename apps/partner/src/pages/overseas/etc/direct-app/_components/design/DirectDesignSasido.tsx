...
const DirectDesignSasido = () => {
  ...
  useEffect(() => {
    ...
    <FormUnitBox vertical title="대표도">
      ...
      <Label htmlFor="directDesignMainImageFile" className={cn("[&>input]:hidden", style)}>
        <Icons.Upload className="size-4" />
        파일등록
        <Input
          id="directDesignMainImageFile"
          type="file"
...
export default DirectDesignSasido;
