...
const MadridRepresentative = () => {
  const { control, setValue } = useFormContext<OverseasMadridFormInput>();
    ...
    <>
      <FormUnitBox vertical title="담당 정보">
        ...
        <RHF.FormField gap={2}>
          ...
          <RHF.Input control={control} name="appManagerInfo.caseMgrInfo.userSeq" type={"hidden"} />
          ...
          <RHF.Input control={control} name="appManagerInfo.attorneyInfo.userSeq" type={"hidden"} />
        </RHF.FormField>
      </FormUnitBox>
...
export default MadridRepresentative;
