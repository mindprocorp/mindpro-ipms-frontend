...
export const Modal23 = ({ title, open, onOpenChange, onSuccess }: ModalProps) => {
    ...
    <FormProvider {...form}>
      ...
      >
        <FlexBox vertical>
          ...
          <FlexBox>
            <RHF.Input control={form.control} name="testVal" label="청구금액" important />
            <RHF.Input control={form.control} name="testVal" label="환산액(KRW)" />
          </FlexBox>
