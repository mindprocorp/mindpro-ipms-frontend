...
export const Modal36 = ({ title, open, onOpenChange, onSuccess }: ModalProps) => {
  ...
  return (
    <FormProvider {...form}>
      ...
      >
        <FlexBox vertical>
          <FlexBox>
            <RHF.Input control={form.control} name="testVal" label="등록권리자(한글)" disabled />
            <RHF.Input control={form.control} name="testVal" label="등록권리자(영문)" disabled />
